...
docker-compose -f docker-compose.yml up -d ca.example.com orderer.example.com couchdb1 couchdb2 couchdb3 couchdb4 peer0.org1.example.com  peer0.org2.example.com peer1.org1.example.com peer1.org2.example.com cli
docker ps -a
